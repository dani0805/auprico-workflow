...
from auprico_workflow.models import Workflow, State, CurrentObjectState, Transition, Condition, Function, \
...
def execute_transition(workflow_name, transition_name, user, object_id, asynchonous=False):
    state = get_object_state(workflow_name, object_id)
