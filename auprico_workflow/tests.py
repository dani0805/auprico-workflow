...
from auprico_workflow import workflow
from auprico_workflow.models import Workflow, State, Transition, Condition, Function, FunctionParameter, Callback, \
...
class WorkflowTest(TestCase):
    ...
    def setUp(self):
        ...
        wf = Workflow.objects.create(
            name="Test_Workflow",
            object_type="auprico_auth.models.User",
            initial_prefetch="""
                             {
                                "username":"admin",
        ...
        f1 = Function.objects.create(
            ...
            function_module="auprico_workflow.conditions",
            condition=c1
        )
        ...
        cb1 = Callback.objects.create(transition=t1, function_name="_print", function_module="auprico_workflow.tests", order=1)
